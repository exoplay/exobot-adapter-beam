Contributing to exobot-adapter-beam
======================

So you want to contribute to exobot-adapter-beam? Fantastic! Here's a brief overview on
how best to do so.
...
[create an issue](https://github.com/exoplay/exobot-adapter-beam/issues) before putting
...
1. [Fork the repository](https://github.com/exoplay/exobot-adapter-beam/fork_select) to
  your Github account.
...
exobot-adapter-beam is MIT licensed. See details in the LICENSE file. This is a very permissive
